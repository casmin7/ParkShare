...
def main():
    # We will read from s4_polygons.json to see the rotated angles
    ...
    print(f"Battery 4173 count: {len(b4173)}")
    for f in b4173:
        props = f['properties']
        ...
        print(f"ID={props.get('id')} Num={props.get('numar')} Angle={angle:.1f}° Mod={angle_mod:.1f}°")
