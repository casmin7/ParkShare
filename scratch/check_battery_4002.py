...
b4002 = [feat for feat in features if feat['properties'].get('baterie') == '4002']
...
print(f"Battery 4002 count in test_s4_polygons: {len(b4002)}")
# Sort by numar as int
try:
    b4002.sort(key=lambda x: int(x['properties'].get('numar', 0)) if x['properties'].get('numar', '').isdigit() else 999)
except:
    pass
